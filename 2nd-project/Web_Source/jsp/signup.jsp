...
<body>
    ...
    <%
        // 데이터베이스 연결 정보
        String jdbcUrl = "jdbc:mariadb://trd-prd-rds.c5uyogaas21v.ap-northeast-2.rds.amazonaws.com:3306/nolgaja_db?useUnicode=true&characterEncoding=utf8mb4";
        String dbUser = "admin";
        String dbPassword = "seohee12!";
