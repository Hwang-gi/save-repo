...
<body>
    <div class="login-container">
        <h2>로그인</h2>
        <form id="loginForm" action="http://10.100.100.100" method="post" onsubmit="return handleSubmit(event)">
            ...
            <button type="button" onclick="window.location.href = 'http://10.100.100.110/signup.jsp'">회원가입</button>
        </form>
    </div>
    ...
    <%
        if ("POST".equalsIgnoreCase(request.getMethod())) {
            ...
            if (userName != null) {
                ...
                out.println("setTimeout(() => { window.location.href = 'http://10.100.100.120/order.jsp?id=" + userName + "'; }, 2000);");
                out.println("</script>");
            } else {
